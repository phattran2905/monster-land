		...
		<Container>
			<div className="flex flex-col justify-between">
				...
				<div className="w-full h-full flex flex-row">
					...
					{/* Golden Board */}
					<div className="w-full p-12 flex flex-col justify-start items-center">
						{/* Title */}
									...
									<div className="flex flex-col w-96">
										...
										<div className="w-full rounded-lg shadow-md shadow-Royal-Blue">
											...
											<div className="p-4 bg-Indigo-Blue w-full">
												<p className="font-bold text-white text-center text-xl">{topLevel?.name}</p>
											</div>
											{/* Attribute */}
												...
												<div className="flex flex-row justify-between items-center">
													<div className="flex flex-row items-center">
														<GiBroadsword
															...
															className="text-Flamingo-Pink"
														/>
														<span className="text-Indigo-Blue font-bold mx-2 text-lg">Attack</span>
													</div>
													<div className="bg-Flamingo-Pink rounded-lg py-2 px-4">
												...
												<div className="flex flex-row justify-between items-center">
													<div className="flex flex-row items-center">
														<GiLightningShield
															...
															className="text-Flamingo-Pink"
														/>
														<span className="text-Indigo-Blue font-bold mx-2 text-lg">Defense</span>
													</div>
													<div className="bg-Flamingo-Pink rounded-lg py-2 px-4">
